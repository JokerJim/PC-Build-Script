...
mkdir c:\Pirum
copy .\media\* c:\Pirum\personalize
...
powershell.exe -ExecutionPolicy Bypass -noprofile -command "&{start-process powershell -ArgumentList '-noprofile -file \"c:\Pirum\PC-Build-Script-master\PCSetup.ps1\"' -verb RunAs}"
